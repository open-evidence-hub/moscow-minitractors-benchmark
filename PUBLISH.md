...
1. Распакуйте архив в корень публичного репозитория https://github.com/microgrin71-sudo/moscow-minitractors-benchmark.
...
6. Поставьте ссылку на опубликованный выпуск со страниц, которые уже индексируются, и укажите дату отсечения 2026-09-21.
